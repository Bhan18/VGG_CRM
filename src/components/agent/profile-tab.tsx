...
function ChangeMpinCard() {
  ...
  const inputClass =
    "w-full rounded-xl border border-[color-mix(in_srgb,var(--brand-emerald)_15%,#e5e0d4)] bg-white px-3 py-2.5 text-center text-lg font-semibold tracking-[0.3em] outline-none focus:border-[var(--brand-emerald)] focus:ring-2 focus:ring-[color-mix(in_srgb,var(--brand-emerald)_20%,transparent)]";
    ...
    <div className="mt-4">
      ...
      >
        <button
          ...
          aria-expanded={open}
        >
          <KeyRound className="h-4 w-4" style={{ color: "var(--brand-golden)" }} />
        ...
        {open && (
          <form onSubmit={onSubmit} className="flex flex-col gap-3 p-4">
            <div className="flex flex-col gap-1.5">
              <label className="text-xs font-medium text-[var(--brand-ink)]/70">Current MPIN</label>
              <input
                type="password"
                inputMode="numeric"
                maxLength={4}
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-xs font-medium text-[var(--brand-ink)]/70">New MPIN</label>
              <input
                type="password"
                inputMode="numeric"
                maxLength={4}
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-xs font-medium text-[var(--brand-ink)]/70">Confirm new MPIN</label>
              <input
                type="password"
                inputMode="numeric"
                maxLength={4}
            ...
            <button
              ...
              style={{
                background:
                  "linear-gradient(135deg, var(--brand-golden) 0%, color-mix(in srgb, var(--brand-golden) 80%, var(--brand-emerald)) 100%)",
              }}
            >
